    ...
    for jj, scenario in enumerate(test_scenario):
        ...
        for i in range(loop):
            ...
            if model_name in ["User33", "User34", "User35"]:
                model_path = f'../8.3.6_ImpactsofGenetics/Model_Am/Am_{model_name}.pth'
                mean_feature = torch.load(f'../8.3.6_ImpactsofGenetics/Dataset_NeckPass/{model_name}/mean_feature.pt')
            else:
