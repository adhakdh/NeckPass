...
class ASTModel(nn.Module):
    def __init__(self, label_dim=32, fstride=10, tstride=8, input_fdim=128*1, input_tdim=24, imagenet_pretrain=True, audioset_pretrain=False, model_size='base384', verbose=False):
